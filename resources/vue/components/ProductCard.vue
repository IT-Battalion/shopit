<template>
  ...
  <div class="grid items-center grid-rows-3 rid-cols-2 justify-items-center">
    ...
    <p class="text-sm font-medium text-gray-300 col-span-full">
      {{ product?.price }}
    </p>
    <div class="row-span-1">
      <button
        class="w-24 col-span-1 px-2 py-1 bg-white rounded-3xl hover:bg-gray-300"
        type="button"
      >
        <svg
          fill="#000"
      ...
      <button
        class="w-24 col-span-1 row-span-1 py-1 bg-white  rounded-3xl hover:bg-gray-300"
        type="button"
      >
        <InformationCircleIcon class="mx-auto w-7 h-7" />
      </button>
    </div>
  </div>
</template>
