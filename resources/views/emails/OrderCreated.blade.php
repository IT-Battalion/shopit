...
@import url(https://fonts.googleapis.com/css?family=Poppins:400,700);
    ...
    @media only screen and (max-width:480px) {
      ...
      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1.5;text-align:left;color:#000000;"><p style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial; text-align: center;"><span style="color: #ecf0f1; font-family: Poppins, sans-serif; font-size: 20px;">Sehr geehrte(r) {{$order->customer->firstname}} {{$order->customer->lastname}},</span></p>
